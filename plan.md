...
> **Superseded for product scope.** The authoritative specification is the Final Master Cursor Specification (Biological OS + Master Personal Portal). Current engineering sequence: `docs/PRODUCT_GAP_ANALYSIS.md` and `docs/IMPLEMENTATION_PLAN.md`. This file remains for historical MVP phase notes and non-conflicting operational rules.
