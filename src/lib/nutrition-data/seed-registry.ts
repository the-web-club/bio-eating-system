...
export async function seedDataSourceRegistry(prisma: PrismaClient) {
  const rows = [
    ...
    },
    {
      ...
      notes: "Primary production food-composition source. Current default import: 2026-04-30-production-slice-v3 (363 Foundation foods).",
    },
    {
    ...
    },
    {
      ...
      accessMethod: "download-api",
      license: "Terms not verified for commercial redistribution",
      termsUrl: "https://phytohub.eu/",
      sourceUrl: "https://phytohub.eu/",
      commercialUseAllowed: false,
      storageAllowed: false,
      transformationAllowed: false,
      customerDisplayAllowed: false,
      ...
      status: "REVIEW_REQUIRED" as const,
      notes:
        "Reserved adapter only. Production import blocked until official commercial reuse terms are verified.",
    },
    {
    ...
    },
    {
      ...
      license: "Official FSANZ terms require audit",
      ...
      devOnly: false,
      status: "REVIEW_REQUIRED" as const,
      notes: "National composition candidate. Commercial reuse audit required.",
    },
    {
      ...
      datasetName: "CNF",
      accessMethod: "download",
      license: "Open Government terms require audit",
      termsUrl:
    ...
    },
    {
      ...
      datasetName: "Ciqual",
      accessMethod: "download",
      license: "ANSES open-data licence requires audit",
